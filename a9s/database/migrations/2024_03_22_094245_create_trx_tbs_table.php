...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('trx_tbs', function (Blueprint $table) {
            ...
            $table->string('supir',50);
            $table->bigInteger('pv');
            $table->bigInteger('tiket_a');
            $table->bigInteger('tiket_b');
            $table->bigInteger('bruto_a');
            $table->bigInteger('tara_a');
            $table->bigInteger('netto_a');
            $table->bigInteger('bruto_b');
            $table->bigInteger('tara_b');
            $table->bigInteger('netto_b');
