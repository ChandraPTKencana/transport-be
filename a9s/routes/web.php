...
|
*/
Route::middleware('no-prefix-api')->group(function () {
    Route::get('/', function () {
        return env('APP_NAME');
        return view('welcome');
    });
    ...
    Route::get('/trx_trp/link_to_extramoney_trx', [\App\Http\Controllers\Transaction\TrxTrpController::class, 'LinkToExtraMoneyTrx']);
    ...
    Route::delete('/fin_payment_req_dtl/delete_data', [\App\Http\Controllers\Finance\FinPaymentReqController::class, 'deleteData']);
    ...
    Route::get('/potongan_mst/attachment/{id}/{n}', [\App\Http\Controllers\Potongan\PotonganMstController::class, 'getAttachment']);
    ...
    Route::post('/rpt_salary', [\App\Http\Controllers\Salary\RptSalaryController::class, 'store']);
    Route::put('/rpt_salary', [\App\Http\Controllers\Salary\RptSalaryController::class, 'update']);
    // Route::delete('/rpt_salary', [\App\Http\Controllers\Standby\StandbyTrxController::class, 'delete']);
