<table class="line borderless text-center mt-2" style="font-size: x-small;">
  <thead class="text-center" style="background-color: #B0A4A4;">
    ...
    <tr>
      ...
      <th colspan="2" style="border: 1px solid black;">Penerima</th>
      ...
      <th rowspan="2" style="border: 1px solid black;">ID Trx Trp</th>
  ...
  <tbody>  
    ...
    <tr>
      ...
      <td style="border: 1px solid black;">{{ $v["employee_rek_no"] ? mb_strtoupper("'".$v["employee_rek_no"],'UTF-8') : '' }}</td>
      <td style="border: 1px solid black;">{{ $v["employee_rek_name"] }}</td>
