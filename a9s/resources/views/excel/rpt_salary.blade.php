<table class="line borderless text-center mt-2" style="font-size: x-small;">
      ...
      <tbody>
        ...
        @php
          ...
          $bonus_gaji = $v["trip_cpo_bonus_gaji"]+$v["trip_pk_bonus_gaji"]+$v["trip_cangkang_bonus_gaji"]+$v["trip_tbs_bonus_gaji"]+$v["trip_tbsk_bonus_gaji"];
          $bonus_dinas = $v["trip_cpo_bonus_dinas"]+$v["trip_pk_bonus_dinas"]+$v["trip_cangkang_bonus_dinas"]+$v["trip_tbs_bonus_dinas"]+$v["trip_tbsk_bonus_dinas"];
        @endphp
        <tr>
          ...
          </td><td style="border: 1px solid black; font-weight:bold;" class="text-right p-1">
        ...
        <tr>
          ...
          <td style="border: 1px solid black; font-weight:bold;" class="p-1" > =SUM(AT{{ $row_jump + 1 }}:AT{{ count($data) + $row_jump }})</td>
          <td style="border: 1px solid black; font-weight:bold;" class="p-1" > =SUM(AU{{ $row_jump + 1 }}:AU{{ count($data) + $row_jump }})</td>
        </tr>
      </tbody>
    </table>