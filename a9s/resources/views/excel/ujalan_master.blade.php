<table class="line borderless text-center mt-2" style="font-size: x-small;">
  @foreach($data as $kdt=>$vdt)
    ...
    <tr>
      ...
      <td style="border: 1px solid black;"> {{ $vdt["jenis"] }} </td>
      <td style="border: 1px solid black;"> {{ $vdt["asst_opt"] }} </td>
      <td style="border: 1px solid black;"> {{ $vdt["harga"] }} </td>
    </tr>
    <tr>
      <th colspan="9"></th>
    </tr>
    ...
    <tr>
      <td colspan="4" style="border: 1px solid black;"> {{ $vdt["xto"] }} </td>
    </tr>
    <tr>
      <th colspan="9"></th>
    </tr>
    ...
    <tr>
      <td colspan="4" style="border: 1px solid black;"> {{ $vdt["tipe"] }} </td>
    </tr>
    <tr>
      <th colspan="9"></th>
    </tr>
    ...
    <tr>
      <td style="border: 1px solid black;"> {{ $vdt["bonus_trip_supir"] }} </td>
      <td style="border: 1px solid black;"> {{ $vdt["bonus_trip_kernet"] }} </td>
      <td style="border: 1px solid black;"> {{ $vdt["km_range"] }} </td>
      <td style="border: 1px solid black;"> {{ $vdt["transition_from"] }} </td>
    </tr>
    <tr>
      <th colspan="9"></th>
    </tr>
