<table class="line borderless text-center mt-2" style="font-size: x-small;">
  <thead class="text-center" style="background-color: #B0A4A4;">
    <tr>
      ...
      <th rowspan="2" style="border: 1px solid black;">Note</th>
      <th colspan="4" style="border: 1px solid black;">Absensi</th>
    </tr>
    <tr>
  ...
  <tbody>  
    ...
    <tr>
      ...
      <td style="border: 1px solid black;">{{ $v["ritase_note"] }}</td>
      <td style="border: 1px solid black;">{{ $v["ritase_leave_at"] ? 'Y' : 'N' }}</td>
      <td style="border: 1px solid black;">{{ $v["ritase_arrive_at"] ? 'Y' : 'N' }}</td>
      <td style="border: 1px solid black;">{{ $v["ritase_return_at"] ? 'Y' : 'N' }}</td>
      <td style="border: 1px solid black;">{{ $v["ritase_till_at"] ? 'Y' : 'N' }}</td>
    </tr>
    @endforeach
  </tbody>
</table>
