...
class ExtraMoneyTrxResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'attachment_1'          => null,
            'attachment_1_preview'  => $this->attachment_1_loc && Storage::disk('public')->exists($this->attachment_1_loc) ? "extra_money_trx/attachment/".$this->id."/1":"",
            ...
            'attachment_2'          => null,
            'attachment_2_preview'  => $this->attachment_2_loc && Storage::disk('public')->exists($this->attachment_2_loc) ? "extra_money_trx/attachment/".$this->id."/2" :"",
