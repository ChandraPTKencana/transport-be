...
class RunTicketToAscend extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'run_ticket_to_ascend';
    ...
    public function handle()
    {
        ...
        ->chunkById(10, function ($stds) use($connectionDB) {
            ...
            foreach ($stds as $std) {
                ...
                ->update([
                    "BrutoTerima" => $std->ticket_b_bruto,    
                    "TaraTerima" => $std->ticket_b_tara,    
                ]);
